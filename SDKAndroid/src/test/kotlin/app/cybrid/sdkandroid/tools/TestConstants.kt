...
object TestConstants {
    ...
    val externalBankAccount = ExternalBankAccountBankModel(
        guid = "12345"
    )
    ...
    const val FETCH_EXTERNAL_BANK_ACCOUNT = "{\"guid\":\"stringstringstringstringstringst\",\"name\":\"string\",\"asset\":\"string\",\"account_kind\":\"plaid\",\"environment\":\"sandbox\",\"bank_guid\":\"stringstringstringstringstringst\",\"customer_guid\":\"stringstringstringstringstringst\",\"created_at\":\"2023-01-23T20:51:24.262Z\",\"plaid_institution_id\":\"string\",\"plaid_account_mask\":\"string\",\"plaid_account_name\":\"string\",\"state\":\"storing\",\"failure_code\":\"string\"}"
    const val DELETE_EXTERNAL_BANK_ACCOUNT = "{\"guid\":\"stringstringstringstringstringst\",\"name\":\"string\",\"asset\":\"string\",\"account_kind\":\"plaid\",\"environment\":\"sandbox\",\"bank_guid\":\"stringstringstringstringstringst\",\"customer_guid\":\"stringstringstringstringstringst\",\"created_at\":\"2023-04-14T17:43:46.581Z\",\"plaid_institution_id\":\"string\",\"plaid_account_mask\":\"string\",\"plaid_account_name\":\"string\",\"state\":\"storing\",\"failure_code\":\"string\"}"
    const val PATCH_EXTERNAL_BANK_ACCOUNT = "{\"guid\":\"stringstringstringstringstringst\",\"name\":\"string\",\"asset\":\"string\",\"account_kind\":\"plaid\",\"environment\":\"sandbox\",\"bank_guid\":\"stringstringstringstringstringst\",\"customer_guid\":\"stringstringstringstringstringst\",\"created_at\":\"2023-04-14T18:50:59.759Z\",\"plaid_institution_id\":\"string\",\"plaid_account_mask\":\"string\",\"plaid_account_name\":\"string\",\"state\":\"storing\",\"failure_code\":\"string\"}"
    ...
    const val CREATE_TRANSFER_SUCCESS = "{\"guid\":\"stringstringstringstringstringst\",\"transfer_type\":\"savings\",\"customer_guid\":\"stringstringstringstringstringst\",\"quote_guid\":\"stringstringstringstringstringst\",\"asset\":\"string\",\"side\":\"deposit\",\"state\":\"storing\",\"amount\":0,\"estimated_amount\":0,\"fee\":0,\"created_at\":\"2023-01-04T03:14:13.471Z\"}"
    const val FETCH_TRANSFERS_SUCCESS = "{\"total\":1,\"page\":0,\"per_page\":1,\"objects\":[{\"guid\":\"stringstringstringstringstringst\",\"transfer_type\":\"savings\",\"customer_guid\":\"stringstringstringstringstringst\",\"quote_guid\":\"stringstringstringstringstringst\",\"asset\":\"string\",\"side\":\"deposit\",\"state\":\"storing\",\"amount\":0,\"estimated_amount\":0,\"fee\":0,\"created_at\":\"2023-01-24T16:59:23.606Z\"}]}"
